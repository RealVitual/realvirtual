...
OVERLAY.addEventListener('click',function(e){
	...
	document.getElementsByClassName('formRegistroExitoso')[0]?.classList.remove('active');
	...
	document.getElementsByClassName('b25Popup')[0]?.classList.remove('active');
	document.getElementsByClassName('b1PopupInfo')[0]?.classList.remove('active');
	document.getElementsByClassName('b3Popup')[0]?.classList.remove('active');
...
if(document.getElementsByClassName('headerButtonLogin')[0] || document.getElementsByClassName('headerButtonRegistrate')[0]){
	...
	for(const buttonClosePopup of elbuttonClosePopup)
	...
	if(document.getElementById("b1ButtonRegister")){
		let b1ButtonRegister = document.getElementById("b1ButtonRegister");
		b1ButtonRegister.addEventListener('click',function(e){
			e.preventDefault();
			document.getElementsByClassName("closeIniciaSesion")[0].click();
			elHeaderButtonRegistrate.click()
		});
...
if(document.getElementsByClassName("headerAnclaBlock")[0]){
	...
	window.addEventListener('scroll', function() {
		...
		document.querySelectorAll('.anclaBlock').forEach(section => {
		...
		if (currentSectionId) {
			document.querySelectorAll('.headerAnclaBlock').forEach(link => {
...
if(document.getElementsByClassName('headerNameUser')[0]){
	let elheaderNameUser = document.getElementsByClassName('headerNameUser')[0];
	elheaderNameUser.addEventListener('click',function(e){
		e.preventDefault();
